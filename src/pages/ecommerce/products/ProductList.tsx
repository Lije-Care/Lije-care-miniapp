...
const products = [
  ...
  { img: product1, name: "Coming", description: "Soon..", price: 120 },
  { img: product1, name: "Coming", description: "Soon..", price: 100 },
  { img: product1, name: "Coming", description: "Soon..", price: 120 },
  { img: product1, name: "Coming", description: "Soon..", price: 100 },
  { img: product1, name: "Coming", description: "Soon..", price: 120 },
...
const ProductCard = ({ product }: {product: any}) => {
  return (
    <div className="p-2 rounded-lg shadow-md w-40">
      ...
      <Headline className="text-sm font-semibold mt-2">{product.name} <span className="text-xs ">{product.description}</span></Headline>
